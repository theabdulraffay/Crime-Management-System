...
public class VehicleSearchForm extends JFrame
{
    JLabel searchId;
    ...
    VehicleSearchForm()
    {
        ...
        searchId = new JLabel("Chasi No to Search");
    ...
    class MyActionListener implements ActionListener           
    {
        public void actionPerformed(ActionEvent ae)
        {
            if(ae.getActionCommand().equals("Search"))
            {
                ...
                JOptionPane.showMessageDialog(null,Vehicle.searchByChasiNo(id).toString());
                dispose();
